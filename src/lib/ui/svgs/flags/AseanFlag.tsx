...
const AseanFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" id="flag-icons-asean" viewBox="0 0 640 480" {...props}>
      <path fill="#0039a6" strokeWidth="4.52548" d="M0 0h640v480H0z" />
      <circle cx="320" cy="240" r="144" fill="#fff" strokeWidth="4.8" />
      <circle cx="320" cy="240" r="137.3" fill="#ed2939" strokeWidth="4.8" />
