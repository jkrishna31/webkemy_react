...
const IsraelFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-il" viewBox="0 0 640 480" {...props}>
      <defs>
        <clipPath id="il-a">
          <path fillOpacity=".7" d="M-87.6 0H595v512H-87.6z" />
        </clipPath>
      </defs>
      <g fill-rule="evenodd" clipPath="url(#il-a)" transform="translate(82.1)scale(.94)">
