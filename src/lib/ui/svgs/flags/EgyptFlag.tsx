...
const EgyptFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="flag-icons-eg" viewBox="0 0 640 480" {...props}>
      ...
      <g fill="#fff" stroke="#c09300" transform="translate(-40)scale(.8)">
        ...
        <g stroke-linecap="round" strokeLinejoin="round" strokeWidth="1.3">
