...
const DemocraticRepublicCongoFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-cd" viewBox="0 0 640 480" {...props}>
...
export default DemocraticRepublicCongoFlag;
