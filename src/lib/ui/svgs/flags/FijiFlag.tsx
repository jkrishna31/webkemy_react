...
const FijiFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-fj" viewBox="0 0 640 480" {...props}>
      ...
      <g strokeMiterlimit="4.8">
        ...
        <g fill="#964b36" stroke="#000" strokeWidth=".5">
          <path strokeWidth=".3" d="M549.4 334.8s5.6-7.4 10.6-5.5 8.1 3 8.1 3 .1 4.9-2.5 4.9-5.2-5-7.6-3.5a13 13 0 0 0-4.5 4.2c-.1.7-6.3.8-4.1-3.1z" />
