...
const UzbekistanFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="flag-icons-uz" viewBox="0 0 640 480" {...props}>
