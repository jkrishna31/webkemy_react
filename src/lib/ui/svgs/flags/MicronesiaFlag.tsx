...
const MicronesiaFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-fm" viewBox="0 0 640 480" {...props}>
      <defs>
        <clipPath id="fm-a">
          <path fillOpacity=".7" d="M-81.3 0h682.6v512H-81.3z" />
        </clipPath>
      </defs>
      <g fillRule="evenodd" strokeWidth="1pt" clip-path="url(#fm-a)" transform="translate(76.3)scale(.94)">
