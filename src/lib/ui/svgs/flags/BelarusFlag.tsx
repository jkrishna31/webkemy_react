...
const BelarusFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" id="flag-icons-by" viewBox="0 0 640 480" {...props}>
      <defs>
        <clipPath id="by-a">
