...
const TurksAndCaicosIslandsFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="flag-icons-tc" viewBox="0 0 640 480" {...props}>
      ...
      <g fill="none" stroke="#000">
        ...
        <g strokeLinecap="round" stroke-linejoin="round" strokeWidth="2.2">
