...
const BahamasFlag = (props: SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-bs" viewBox="0 0 640 480" {...props}>
      <defs>
        <clipPath id="bs-a">
          <path fillOpacity=".7" d="M-12 0h640v480H-12z" />
        </clipPath>
      </defs>
      <g fillRule="evenodd" clip-path="url(#bs-a)" transform="translate(12)">
