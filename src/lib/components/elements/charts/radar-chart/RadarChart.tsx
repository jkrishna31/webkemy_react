...
export interface IRadarChartProps extends HTMLProps<HTMLElement> {
  width?: number
  height?: number
  margin?: IMargins
  fit?: boolean
...
export const RadarChart: FC<IRadarChartProps> = ({
  ...
  const renderGraph = useCallback(() => {
    ...
    const SIDES = 6, LEVELS = 5, OFFSET = Math.PI, POLYANGLE = (Math.PI * 2) / SIDES;
    ...
    // RadarChart(".radarChart", radarChartData, {
    //   w: width,
    //   h: height,
    //   margin: margin,
    //   maxValue: 0.5,
