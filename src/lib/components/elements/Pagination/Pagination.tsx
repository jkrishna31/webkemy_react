...
const Pagination = ({
    ...
    return (
        <div className={classes(styles.pagination, className)}>
            <Button
                variant="solid" className={classes(styles.pagination_btn, styles.prev)} title="Previous"
            ...
            <div className={styles.all_pages}>
                ...
                </Button>
                {
                    siblingCount ? (
                        ...
                        >
                            ...
                            {currentPage !== value && (
                                <Button
                                    variant="solid" type="submit" disabled={currentPage === value}
                ...
                <Button
                    variant="outlined" className={styles.page_boundary_btn} title="Last Page"
            ...
            <Button
                variant="solid" className={classes(styles.pagination_btn, styles.next)} title="Next"
                onClick={() => handleChange(currentPage + 1)}
                disabled={currentPage === totalPages}
            >
