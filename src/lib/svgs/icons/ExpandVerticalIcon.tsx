...
const ExpandVerticalIcon = (props: SVGProps) => {
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" {...props}><path d="m7 15l5 5l5-5M7 9l5-5l5 5" /></svg>
  );
};
