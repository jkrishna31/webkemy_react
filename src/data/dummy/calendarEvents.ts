...
export const allEvents: CalendarEvent[] = [
...

  {
    id: "ev41",
    title: "Team Breakfast",
    start: new Date(_year, _month, 4, 3).toUTCString(),
    end: new Date(_year, _month, 4, 5, 30).toUTCString(),
  },
  {
    id: "ev42",
    title: "Happy Hour",
    start: new Date(_year, _month, 4, 7, 45).toUTCString(),
    end: new Date(_year, _month, 5, 1, 15).toUTCString(),
    color: "red",
  },
  {
    id: "cxk",
    title: "Asia Market Review",
    start: new Date(_year, _month, 8, 2).toUTCString(),
    end: new Date(_year, _month, 8, 4, 40).toUTCString(),
    color: "yellow",
  },
  {
    id: "cxkl",
    title: "Workshop A",
    start: new Date(_year, _month, 10, 10).toUTCString(),
    end: new Date(_year, _month, 10, 10, 45).toUTCString(),
  },
  {
    id: "cxmj",
    title: "Early Strategy Metting",
    start: new Date(_year, _month, 18, 9, 15).toUTCString(),
    end: new Date(_year, _month, 18, 10, 30).toUTCString(),
    color: "blue",
  },
  {
    id: " ds",
    title: "Training Session Mock",
    start: new Date(_year, _month, 20, 20, 45).toUTCString(),
    end: new Date(_year, _month, 21, 0, 30).toUTCString(),
    color: "blue",
  },
  {
    id: " l232",
    title: "Conference A",
    start: new Date(_year, _month, 21, 20, 0).toUTCString(),
    end: new Date(_year, _month, 23, 3, 15).toUTCString(),
    color: "green",
  },
  {
    id: " cds",
    title: "Board Meeting",
    start: new Date(_year, _month, 21, 4, 20).toUTCString(),
    end: new Date(_year, _month, 21, 5, 0).toUTCString(),
  },
  {
    id: " 323s",
    title: "Event Title",
    start: new Date(_year, _month, 21, 10, 0).toUTCString(),
    end: new Date(_year, _month, 21, 12, 30).toUTCString(),
    color: "yellow",
  },
  {
    id: " cxlk",
    title: "Dummy Testing",
    start: new Date(_year, _month, 21, 12, 0).toUTCString(),
    end: new Date(_year, _month, 21, 15, 45).toUTCString(),
    color: "red",
  },
  {
    id: " ds78ds",
    title: "Board Meeting",
    start: new Date(_year, _month, 30, 3, 15).toUTCString(),
    end: new Date(_year, _month, 30, 6, 30).toUTCString(),
    color: "orange",
  },
];
