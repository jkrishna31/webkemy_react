...
export default function Home() {
  return (
    <main className={styles.main}>
      ...
      {/* <div className={styles.main_panel_left}><div></div></div> */}
      {/* <div className={styles.main_panel_right}><div></div></div> */}
      {/* <div className={styles.main_panel_center}><div></div></div> */}
      <div className={styles.card}>
        <Text<"h1"> as="h1" className={styles.title}>
          {/* {"WEBKEMY"} */}
          <AppLogo className={styles.logo} />
        </Text>
        <Text<"p"> as="p" className={styles.desc}>{"Minimal. Accessible. Easily-Extensible. UI Elements."}</Text>
